...
= 1.4 =
* Bug Fixes : Plugin form setting page, paasword strength meter live analysis issue resolved.

= 1.3 =
* Bug Fixes : Resolved plugin errors with latest menu and submenu function.
*  Plugin pages edit screen not opening while editing page from WordPress dashboard issue resolved
